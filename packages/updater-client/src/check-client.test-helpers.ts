/**
 * Servidor HTTP real y mínimo para testear `check-client.ts` contra
 * comportamientos que un mock no reproduciría de forma creíble: timeouts
 * reales, un servidor que tarda, o que devuelve JSON con forma inválida.
 */
