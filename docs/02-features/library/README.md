...
decisiones locales que no ameritaron un ADR.

## Estado

Fase 2 en progreso: repositorio, servicio y handlers de main completos y testeados. El
lado del renderer (grid virtualizado, filtros, búsqueda, caché de portadas) todavía no
existe.
